...
banner() {
	cat <<- EOF
		${ORANGE}
		${ORANGE}
		${ORANGE} .d88888b.                  .d88888b.                                 
		${ORANGE}d88P" "Y88b                d88P" "Y88b                                
		${ORANGE}888     888                888     888                                
		${ORANGE}888     88888888b.  .d88b. 888     88888888888 .d88b. 888d888 .d88b.  
		${ORANGE}888     888888 "88bd8P  Y8b888     888   d88P d8P  Y8b888P"  d88""88b 
		${ORANGE}888     888888  88888888888888     888  d88P  88888888888    888  888 
		${ORANGE}Y88b. .d88P888  888Y8b.    Y88b. .d88P d88P   Y8b.    888    Y88..88P 
 		${ORANGE}"Y88888P" 888  888 "Y8888  "Y88888P" 88888888 "Y8888 888     "Y88P"  

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by OneOzero[Mohammadreza Payami] ${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
		...
		${ORANGE}  ____              ____                    
		${ORANGE} / __ \            / __ \                   
		${ORANGE}| |  | |_ __   ___| |  | |_______ _ __ ___  
		${ORANGE}| |  | | '_ \ / _ \ |  | |_  / _ \ '__/ _ \ 
		${ORANGE}| |__| | | | |  __/ |__| |/ /  __/ | | (_) |
		${ORANGE} \____/|_| |_|\___|\____//___\___|_|  \___/${WHITE} ${__version__}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN} Author   ${RED}:  ${ORANGE}Phishing Tools ${RED}[ ${ORANGE}Mohammad Reza Payami ${RED}]
		${GREEN} Github   ${RED}:  ${CYAN}@oneOzero
